    ...
    final child = Column(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const EmailRegistrationScreen()),
            );
          },
        ),
        if (_error != null) ...[
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      assert(kAppsScriptUrl.startsWith('https://script.google.com/macros/s/') &&
          kAppsScriptUrl.endsWith('/exec'));
      debugPrint('POST to $kAppsScriptUrl');
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'Vecino/a', child: Text('Vecino/a')),
                      DropdownMenuItem(
                          value: 'Personal Administrativo', child: Text('Personal Administrativo')),
                    ],
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      ...
                      label:
                          _sending ? const Text('Enviando…') : const Text('Guardar registro'),
                      onPressed: _sending ? null : _submit,
                    ),
                  ),
                  if (_feedback != null) ...[
